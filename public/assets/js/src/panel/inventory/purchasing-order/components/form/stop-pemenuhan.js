...
class FormStopPemenuhan extends FormManager {
  ...
  handleSuccessResponse = async (response) => {
    swalSuccess(response.message, async () => {
      ...
      modalUpdateProsesPesanan.modal('hide');
      this.emptyForm();
    });
  };
...
const formStopPemenuhan = new FormStopPemenuhan(
  $(`#${attributeName()[0]['formStopPemenuhan']}`),
  $(`#${attributeName()[0]['modalStopPemenuhan']}`),
  $(`#${attributeName()[0]['submitStopPemenuhanButton']}`)
);
export { formStopPemenuhan };
