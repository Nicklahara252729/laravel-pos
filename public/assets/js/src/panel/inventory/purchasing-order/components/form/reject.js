...
class FormReject extends FormManager {
...
const formReject = new FormReject(
  $(`#${attributeName()[0]['formReject']}`),
  $(`#${attributeName()[0]['modalReject']}`),
  $(`#${attributeName()[0]['submitRejectButton']}`)
);
export { formReject };
