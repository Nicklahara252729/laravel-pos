...
class ModalBahan {
  ...
  constructor() {
    ...
    this.modalResep = $(`#${attributeName()[0]['modalResep']}`);
  }
   ...
   */
  modalBahanHandler(data) {
    this.modal.modal('show');
    $(`${this.modalResep.selector} .modal-content`).addClass('dim');
    this.modal.on('hide.bs.modal', () => {
      $(`${this.modalResep.selector} .modal-content`).removeClass('dim');
    });
