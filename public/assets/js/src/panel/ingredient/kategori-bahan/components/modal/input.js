 ...
 * import repositories
 */
import { getKategoriBahanByIdAPI } from '../../repositories/repositories.js';
...
class ModalInput {
  ...
  constructor() {
    ...
    this.titleModal = $(`${this.modal.selector} .modal-header h5`);
  ...
  async modalEditHandler(param) {
    ...
    const dataKategoriProduk = await getKategoriBahanByIdAPI(param.uuidKategori);
    this.formManager.fillForm(dataKategoriProduk);
