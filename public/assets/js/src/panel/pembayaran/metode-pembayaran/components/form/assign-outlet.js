...
class FormAssignOutlet extends FormManager {
...
const formAssignOutlet = new FormAssignOutlet(
  $(`#${attributeName()[0]['formAssignOutlet']}`),
  $(`#${attributeName()[0]['modalAssignOutlet']}`),
  $(`#${attributeName()[0]['submitAssignOutletButton']}`)
);
export { formAssignOutlet };
