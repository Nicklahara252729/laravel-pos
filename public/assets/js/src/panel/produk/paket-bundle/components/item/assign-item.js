      ...
      const rowHtml = `
          <section class="mb-4">
              ...
              <div class="flex justify-between mb-2">
                  ...
                  <button class="btn btn-danger ${deleteItemButton}" type="button"><i class="bx bx-trash-alt"></i></button>
              </div>
                  <input type="text" value="${
                    item.item
                  }" name="item[]" id="item" class="form-control" placeholder="Masukkan item" disabled>
              </div>
              <div class="form-group mb-2">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="kuantitas" id="kuantitas[]" class="form-control" placeholder="Masukkan kuantitas item">
              </div>
          </section>
        `;
...
export { productItemEl, listingItem };
