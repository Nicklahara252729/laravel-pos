...
class FormAturMeja extends FormManager {
...
const formAturMeja = new FormAturMeja(
  $(`#${attributeName()[0]['formAturMeja']}`),
  $(`#${attributeName()[0]['modalTableView']}`),
  $(`#${attributeName()[0]['submitAturMejaButton']}`)
);
export { formAturMeja };
