    ...
    <div class="modal-dialog modal-dialog-scrollable modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">Tambah Konfigurasi</h5>
            </div>
            ...
            <div class="modal-footer flex justify-end">
                ...
                <button class="btn btn-primary waves-effect waves-light" type="button" id="submit-metode-pembayaran-button">Simpan</button>
            </div>
        </div>
    </div>
</div>
