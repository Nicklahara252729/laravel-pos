<form enctype="multipart/form-data" id="form-pin-access" class="lg:px-20">
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="print_bill" id="print_bill" value="yes" class="sr-only peer">
            <div
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="manage_all_open_bills" id="manage_all_open_bills" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="apply_discount_bill_item" id="apply_discount_bill_item" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="manage_discounts" id="manage_discounts" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="issue_refunds" id="issue_refunds" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="resend_receipts" id="resend_receipts" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="record_invoice_payments" id="record_invoice_payments" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="cancel_invoices" id="cancel_invoices" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="view_shift_histories" id="view_shift_histories" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="edit_customer_infomation" id="edit_customer_infomation" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
    ...
    <label class="relative inline-flex items-start justify-between mb-2 cursor-pointer w-full">
        ...
        <div class="relative mt-1">
            <input type="checkbox" name="view_activity" id="view_activity" value="yes" class="sr-only peer">
            <div
                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-blue-600">
            </div>
        </div>
