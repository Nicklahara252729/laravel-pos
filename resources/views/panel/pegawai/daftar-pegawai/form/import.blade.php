<form enctype="multipart/form-data" id="form-import">
    Untuk mengunggah item secara masal, pertama - tama unduh <a href="{{asset('assets/files/Import-Daftar-Pegawai.xlsx')}}" class="text-primary">Template kami.</a>
    ...
    <span class="text-secondary">*Pastikan nama outlet, hak akses, dan level pengguna terdaftar sebelumnya. Jika tidak terdaftar maka
        proses import akan gagal.</span>
