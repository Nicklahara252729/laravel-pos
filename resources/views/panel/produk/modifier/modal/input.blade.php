    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-input-title">Tambah Modifier</h5>
            </div>
            ...
            <div class="modal-footer flex justify-end">
                ...
                <button class="btn btn-primary waves-effect waves-light" type="button" id="submit-modifier-button">Simpan</button>
            </div>
        </div>
    </div>
</div>