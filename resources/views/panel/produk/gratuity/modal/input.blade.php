    ...
    <div class="modal-dialog modal-dialog-scrollable modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">Tambah Outlet</h5>
            </div>
            ...
            <div class="modal-footer flex justify-end">
                ...
                <button class="btn btn-primary waves-effect waves-light" data-bs-dismiss="modal" id="submit-gratuity-button">Simpan</button>
            </div>
        </div>
    </div>
</div>
